...
export const metadata: Metadata = {
  ...
  description: "Expert guidance for Nigerian students studying in the UK, Canada, USA, Ireland, Germany & Australia. 398+ students placed. 98% visa success rate.",
  openGraph: {
    title: "Nigeria's Most Trusted Study Abroad Consultant",
    description: '398+ Nigerian students placed. 98% visa success rate.',
